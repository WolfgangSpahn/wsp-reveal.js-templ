/******************************************
* Utility functions for Reveal.js configuration
******************************************/
...
/******************************************
* Helper function for anything plugin
******************************************/
function rollofadie(container, options) {
    // Implementation for roll of a die
    container.innerHTML = Math.trunc(1 + Math.random() * 6);
}
